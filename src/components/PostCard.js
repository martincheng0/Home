    ...
    return (
        <Link to={`/blog${url}`}>
            <div className='relative bg-white rounded-xl border border-black m-6 flex flex-col lg:flex-row'>
                <figure className='lg:max-w-lg'><img className='rounded-t-xl lg:rounded-tr-none lg:rounded-bl-xl self-center oject-fill' src={post.coverImage} alt="Album" /></figure>
