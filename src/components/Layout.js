...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex flex-col h-screen">
      <Disclosure
        as="nav"
        className="z-50 bg-opacity-60 backdrop-filter backdrop-blur-lg top-0 w-full transition-colors ease-in-out duration-300 fixed bg-white"
      >
        {({ open }) => (
          <>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between h-16">
                      ...
                      {navigation.map((item) => (
                        <Link
                          ...
                          activeClassName={classNames(
                            ...
                            colorChange ? "text-gray-100" : "text-white"
                          )}
                ...
                <div className="-mr-2 flex md:hidden">
                  {/* Mobile menu button */}
                  <DisclosureButton className="inline-flex items-center justify-center p-2 rounded-md text-black hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
      ...
      <main>
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">{children}</div>
      </main>
    </div>
  );
};
